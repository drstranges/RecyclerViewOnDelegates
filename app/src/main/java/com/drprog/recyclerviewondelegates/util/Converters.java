...
public class Converters {
    ...
    @BindingAdapter(value = {"glidePath", "glidePlaceholder", "glideCacheStrategy", "glideCrossFadeDisabled", "glideAnimation", "glideTransform"}, requireAll = false)
    public static void setImageUri(ImageView imageView, String path, Drawable placeholder, String glideCacheStrategy, boolean crossFadeDisabled, Integer animationResId, String glideTransform) {
